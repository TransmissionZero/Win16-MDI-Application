...
FIRSTCPP =             
RC = rc
CFLAGS_D_WEXE = /nologo /W3 /Gf /Zi /Od /D "WINVER"="0x0300" /D "_DEBUG" /FR /GA /GEs /GEm /Fd"WIN16MDI.PDB"
...
MDICHWND.OBJ:	MDICHWND.C $(MDICHWND_DEP)
	$(CC) $(CFLAGS) $(CUSEPCHFLAG) /c MDICHWND.C


$(PROJ).EXE::	RESOURCE.RES

$(PROJ).EXE::	ABOUTDLG.OBJ MAINWND.OBJ WINMAIN.OBJ MDICHWND.OBJ $(OBJS_EXT) $(DEFFILE)
	echo >NUL @<<$(PROJ).CRF
ABOUTDLG.OBJ +
MAINWND.OBJ +
WINMAIN.OBJ +
